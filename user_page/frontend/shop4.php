...
.action_buttons {
    ...
    padding: 10px 20px;
    background-color: #fcd7de; /* Màu nền mặc định */
    color: #333; /* Màu chữ */
...
.action_buttons:hover {
    background-color: #f9a1b6; /* Màu nền khi hover */
    color: #333; /* Giữ màu chữ */
}

.action_buttons input[type="submit"] {
    /* Để loại bỏ khung viền và đường viền xung quanh nút submit */
    border: none;
    outline: none;
}
...
<div class="coffee_section layout_padding">
    ...
    <div class="col-lg-3 col-md-6">
        ...
        <div class="action_buttons">
                <a href="cart.php" class="action_button">Go to Shopping</a>
        </div>
        ...
        <div class="action_buttons">
            <form method="post" action="">
                ...
                <button type="submit" class="action_button" value="Add to Cart" name="add_to_cart"> </button>
            </form>
        </div>
